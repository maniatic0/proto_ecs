...
mod tests {
    ...
    use crate::data_group::{DataGroupDesc, DataGroupDyn, DataGroupInitParamsDyn};
    use super::*;
    ...
    */
    ...
    {   
        // TODO still not clear how to do registration of datagroups
        // let datagroup_registry = DataGroupRegistry::load_registered_datagroups();
        // println!("{:?}", datagroup_registry);
    }
